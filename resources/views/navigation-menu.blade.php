        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('patient-biodata') }}" :active="request()->routeIs('patient-biodata')">
                        Biodata Pasien
                    </x-nav-link>

                    <x-nav-link href="{{ route('cancer-category') }}" :active="request()->routeIs('cancer-category')">
                        Jenis Kanker
                    </x-nav-link>

                    <x-nav-link href="{{ route('cancer-detail') }}" :active="request()->routeIs('cancer-detail')">
